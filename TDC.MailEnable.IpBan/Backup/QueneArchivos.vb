...
Namespace Backup
    Public Class QueneArchivos
        ...
        Private Sub BuscadoresEvents_Endground(Sender As Object, Detener As MailEnable.Core.Bucle.BackgroundEventArgs) Handles BuscadoresEvents.EndGround
            If Not IsNothing(Directorios) AndAlso Not Directorios.IsEmpty AndAlso CType(Sender, MailEnable.Core.Bucle.DoBucle).Cancelar Then CType(Sender, MailEnable.Core.Bucle.DoBucle).Iniciar()
        End Sub
